...
function SampleNextArrow(props) {
  ...
  return (
    <div
      className={` absolute left-10 top-[300px] h-8 w-8 rounded-full bg-white border border-slate-600 text-center rotate-180 p-[12px]  flex justify-center items-center  hover:bg-[#088269]  table1080:hidden`}
...
function SamplePrevArrow(props) {
  ...
  return (
    <div
      className={` absolute left-0  top-[300px]  h-8 w-8 rounded-full bg-white border border-slate-600 text-center  p-[12px]  flex justify-center items-center  hover:bg-[#088269]  table1080:hidden`}
